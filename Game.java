...
//			ImageManager.setImage("Wall",ImageIO.read(this.getClass().getResource("/Wall.png")));
//			ImageManager.setImage("Guard", ImageIO.read(this.getClass().getResource("/Guard2.gif")));
//			ImageManager.setImage("AlertGuard", ImageIO.read(this.getClass().getResource("/Guard3.gif")));
//			ImageManager.setImage("Avatar", ImageIO.read(this.getClass().getResource("/Explorer2(17x20).gif")));

//			ImageManager.setImage("FloorTile", ImageIO.read(new File("FloorTile.png")));
//			ImageManager.setImage("Wall",ImageIO.read(new File("Wall.png")));
//			ImageManager.setImage("Guard", ImageIO.read(new File("Guard2.gif")));
//			ImageManager.setImage("AlertGuard", ImageIO.read(new File("Guard3.gif")));
//			ImageManager.setImage("Avatar", ImageIO.read(new File("Explorer2(17x20).gif")));
